...
*/
void llenar_nivel(juego_t* ref_juego, int i_juego, coordenada_t coord_diferentes[MAX_ELEMENTOS], int* ref_tope_coord_dif,config_t configuraciones[MAX_NIVELES]){
    ...
    if((*ref_juego).niveles[i_juego].numero_nivel == NIVEL_1){ 
        ...
        cantidad_obstaculos = configuraciones[NIVEL_1-1].pozos + configuraciones[NIVEL_1-1].interruptores + configuraciones[NIVEL_1-1].velas  + configuraciones[NIVEL_1-1].portales;
        cantidad_herramientas = configuraciones[NIVEL_1-1].escaleras + configuraciones[NIVEL_1-1].llaves + configuraciones[NIVEL_1-1].monedas + CANT_PUERTA;    
        (*ref_juego).niveles[i_juego].tope_obstaculos = cantidad_obstaculos;
        (*ref_juego).niveles[i_juego].tope_herramientas = cantidad_herramientas;
        tope_velas_pozo = configuraciones[NIVEL_1-1].velas + configuraciones[NIVEL_1-1].pozos;
        tope_escalera_moneda = cantidad_herramientas - CANT_PUERTA - configuraciones[NIVEL_1-1].llaves;
        tope_paredes = (*ref_juego).niveles[i_juego].tope_paredes;
        tope_pared_obstaculo = tope_paredes + cantidad_obstaculos;
        pos_interruptor = configuraciones[NIVEL_1-1].velas + configuraciones[NIVEL_1-1].pozos + configuraciones[NIVEL_1-1].interruptores -1;
        pos_puerta = configuraciones[NIVEL_1-1].escaleras + configuraciones[NIVEL_1-1].monedas + CANT_PUERTA - 1;

        generador_coord_no_iguales( coord_diferentes ,(&(*ref_tope_coord_dif)) , (*ref_juego).niveles , NIVEL_1 - 1, configuraciones[NIVEL_1-1].escaleras);     //POS -> POSICION. NV -> NIVEL
        llenar_obstaculos((*ref_juego).niveles[i_juego].obstaculos, cantidad_obstaculos, tope_velas_pozo, configuraciones[NIVEL_1-1].velas, pos_interruptor, tope_paredes, coord_diferentes);
        llenar_herramientas((*ref_juego).niveles,configuraciones[NIVEL_1-1].escaleras,NIVEL_1-1,tope_escalera_moneda ,pos_puerta ,tope_pared_obstaculo ,coord_diferentes);
    }
    else if((*ref_juego).niveles[i_juego].numero_nivel == NIVEL_2){

        cantidad_obstaculos = configuraciones[NIVEL_2-1].pozos + configuraciones[NIVEL_2-1].interruptores + configuraciones[NIVEL_2-1].velas  + configuraciones[NIVEL_2-1].portales;
        cantidad_herramientas = configuraciones[NIVEL_2-1].escaleras + configuraciones[NIVEL_2-1].llaves + configuraciones[NIVEL_2-1].monedas + CANT_PUERTA;    
        (*ref_juego).niveles[i_juego].tope_obstaculos = cantidad_obstaculos;
        (*ref_juego).niveles[i_juego].tope_herramientas = cantidad_herramientas;
        tope_velas_pozo = configuraciones[NIVEL_2-1].velas + configuraciones[NIVEL_2-1].pozos;
        tope_escalera_moneda = cantidad_herramientas - CANT_PUERTA - configuraciones[NIVEL_2-1].llaves;
        tope_paredes = (*ref_juego).niveles[i_juego].tope_paredes;
        tope_pared_obstaculo = tope_paredes + cantidad_obstaculos;
        pos_interruptor = configuraciones[NIVEL_2-1].velas + configuraciones[NIVEL_2-1].pozos + configuraciones[NIVEL_2-1].interruptores -1;
        pos_puerta = configuraciones[NIVEL_2-1].escaleras + configuraciones[NIVEL_2-1].monedas + CANT_PUERTA - 1;

        generador_coord_no_iguales( coord_diferentes ,(&(*ref_tope_coord_dif)) , (*ref_juego).niveles , NIVEL_2 - 1, configuraciones[NIVEL_2-1].escaleras);  
        llenar_obstaculos((*ref_juego).niveles[i_juego].obstaculos ,cantidad_obstaculos, tope_velas_pozo, configuraciones[NIVEL_2-1].velas, pos_interruptor, tope_paredes, coord_diferentes);
        llenar_herramientas((*ref_juego).niveles,configuraciones[NIVEL_2-1].escaleras,NIVEL_2-1 ,tope_escalera_moneda,pos_puerta,tope_pared_obstaculo ,coord_diferentes);
    }
    else if ((*ref_juego).niveles[i_juego].numero_nivel == NIVEL_3){

        cantidad_obstaculos = configuraciones[NIVEL_3-1].pozos + configuraciones[NIVEL_3-1].interruptores + configuraciones[NIVEL_3-1].velas  + configuraciones[NIVEL_3-1].portales;
        cantidad_herramientas = configuraciones[NIVEL_3-1].escaleras + configuraciones[NIVEL_3-1].llaves + configuraciones[NIVEL_3-1].monedas + CANT_PUERTA;    
        (*ref_juego).niveles[i_juego].tope_obstaculos = cantidad_obstaculos;
        (*ref_juego).niveles[i_juego].tope_herramientas = cantidad_herramientas;
        tope_velas_pozo = configuraciones[NIVEL_3-1].velas + configuraciones[NIVEL_3-1].pozos;
        tope_escalera_moneda = cantidad_herramientas - CANT_PUERTA - configuraciones[NIVEL_3-1].llaves;
        tope_paredes = (*ref_juego).niveles[i_juego].tope_paredes;
        tope_pared_obstaculo = tope_paredes + cantidad_obstaculos;
        pos_interruptor = configuraciones[NIVEL_3-1].velas + configuraciones[NIVEL_3-1].pozos + configuraciones[NIVEL_3-1].interruptores -1;
        pos_puerta = configuraciones[NIVEL_3-1].escaleras + configuraciones[NIVEL_3-1].monedas + CANT_PUERTA - 1;

        generador_coord_no_iguales( coord_diferentes ,(&(*ref_tope_coord_dif)) , (*ref_juego).niveles , NIVEL_3 - 1, configuraciones[NIVEL_3-1].escaleras);
        llenar_obstaculos((*ref_juego).niveles[i_juego].obstaculos ,cantidad_obstaculos,tope_velas_pozo ,configuraciones[NIVEL_3-1].velas ,pos_interruptor ,tope_paredes ,coord_diferentes);
        llenar_herramientas((*ref_juego).niveles,configuraciones[NIVEL_3-1].escaleras,NIVEL_3-1 ,tope_escalera_moneda , pos_puerta,tope_pared_obstaculo ,coord_diferentes);
    }  
}
...
void inicializar_juego(juego_t* juego,config_t configuraciones[MAX_NIVELES]){
    ...
    llenar_nivel((&(*juego)),(*juego).nivel_actual-1,coord_diferentes_1,&tope_coord_diferentes_1,configuraciones);
    llenar_nivel((&(*juego)),(*juego).nivel_actual,coord_diferentes_2,&tope_coord_diferentes_2,configuraciones);
    llenar_nivel((&(*juego)),(*juego).nivel_actual+1,coord_diferentes_3,&tope_coord_diferentes_3,configuraciones);    
    
    int cantidad_escaleras = configuraciones[NIVEL_1-1].escaleras;
    int posicion_mac = (*juego).niveles[(*juego).nivel_actual-1].tope_paredes + (*juego).niveles[(*juego).nivel_actual-1].tope_obstaculos + (*juego).niveles[(*juego).nivel_actual-1].tope_herramientas - cantidad_escaleras;
...
void realizar_jugada(juego_t* juego){
    ...
    if(nivel == ESTA_JUGANDO && partida == ESTA_JUGANDO){
        ...
        printf("Cantidad herramientas es : %i\n",(*juego).niveles[(*juego).nivel_actual-1].tope_herramientas);
        //printf("Tope herramientas es : %i\n",(*juego).niveles[NIVEL_2-1].tope_herramientas);
        //printf("Tope herramientas es : %i\n",(*juego).niveles[NIVEL_3-1].tope_herramientas);
        printf("Cantidad obstaculos es : %i\n",(*juego).niveles[(*juego).nivel_actual-1].tope_obstaculos);
        //printf("Tope obstaculos 2 es : %i\n",(*juego).niveles[NIVEL_2-1].tope_obstaculos);
        //printf("Tope obstaculos 3 es : %i\n",(*juego).niveles[NIVEL_3-1].tope_obstaculos);
        printf("Cantidad paredes es : %i\n",(*juego).niveles[(*juego).nivel_actual-1].tope_paredes);
